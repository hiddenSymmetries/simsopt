...
class SurfaceGVECFourierTests(unittest.TestCase):
    def test_names(self):
        """
        Check that dof names are correct.
        """
        surf = SurfaceGVECFourier(mpol=2, ntor=1, nfp=3)
    ...
    def test_names_nonstellsym(self):
        ...
        Check that dof names are correct.
        """
        surf = SurfaceGVECFourier(mpol=1, ntor=1, nfp=3, stellsym=False)
        names = ['X1c(0,0)',  'X1c(0,1)',
                 'X1c(1,-1)', 'X1c(1,0)', 'X1c(1,1)',
                 'X1s(0,1)',
    ...
    def test_change_resolution(self):
        ...
        """
        s1 = SurfaceGVECFourier(mpol=2, ntor=3)

...
class NormalFieldTests(unittest.TestCase):
    ...
    def test_getter_setter(self):
        """
        Check setters / getters of vns, vnc harmonics behave as intended
        """
    ...
    def test_make_names(self):
        """
        Test routine make_names. We verify that first element is vns(0,1), and that
    ...
    def test_fixed_range(self):
        ...
        [self.assertTrue( normal_field.is_free( ii ) ) for ii in range( 0, normal_field.ndof )]

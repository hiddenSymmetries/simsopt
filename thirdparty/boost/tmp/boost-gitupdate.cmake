...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "boost-1.82.0"
  WORKING_DIRECTORY "/Users/sienahurwitz/simsopt/thirdparty/boost/src/boost"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "boost-1.82.0")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("boost-1.82.0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/boost-1.82.0")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"boost-1.82.0\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/sienahurwitz/simsopt/thirdparty/boost/src/boost'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/sienahurwitz/simsopt/thirdparty/boost/src/boost'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

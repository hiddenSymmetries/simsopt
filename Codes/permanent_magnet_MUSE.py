...
if in_github_actions:
    ...
    nphi = int(input('nphi = '))  # >= 64 for high-resolution runs
    nIter_max = int(input('max iterations = '))
    nBacktracking = int(input('backtracking every _ magnets '))
    max_nMagnets = int(input('# magnets = '))
    downsample = int(input('downsample = '))
nAdjacent = int(input('nAdjacent = '))  # How many magnets to consider "adjacent" to one another
...
out_dir = Path(str(input('output name = ')))

...
# KNOWN OPTIMUM
# -----------------------
known_optimum = np.array([ 0.49371758,  0.14645159,  0.46566095,  1.46903445,  0.46281705,
        0.19423864,  0.47945932,  0.18875279, -0.00690128,  2.2715218 ,
        2.89964845,  5.03421271,  0.40825785,  0.37887135,  0.3535172 ,
        0.2070615 , -0.37476876,  2.2134198 ,  2.84986768,  5.23035395,
        0.26575454,  0.48172152,  0.24564381,  0.42259105, -0.7851575 ,
        1.94243757,  3.19331551,  5.3609747 ,  0.03521889,  0.54926332,
        0.20182672,  1.21206746,  1.11092466,  1.70175291, -0.28907806,
        0.52336722,  0.88700027,  1.18146083])
...
if rank == 0:
    ...
    for i in range(dim):
        ...
        plt.figure()
        plt.plot(xs, ys)
        plt.xlabel(f"DOF {i} around known optimum")

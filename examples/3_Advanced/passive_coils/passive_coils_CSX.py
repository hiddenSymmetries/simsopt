...
from simsopt.util import remove_inboard_dipoles, align_dipoles_with_plasma
...
if continuation_run:
    save(btot.Bfields[0].coils, OUT_DIR + 'psc_coils_continuation.json')
    save(btot.Bfields[1].coils, OUT_DIR + 'TF_coils_continuation.json')
else:

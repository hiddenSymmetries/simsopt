...
from simsopt.field.force import LpCurveForce, \
    ...
    SquaredMeanForce, \
    SquaredMeanTorque, LpCurveTorque, regularization_rect
...
def generate_curves():
    ...
    surf = SurfaceRZFourier.from_vmec_input(TEST_DIR / filename, range='half period', nphi=nphi, ntheta=ntheta)
    ...
    # VV.set_rc(0, 0, surf.get_rc(0, 0))
    # VV.set_rc(1, 0, surf.get_rc(1, 0) * 3)
    # VV.set_zs(1, 0, surf.get_zs(1, 0) * 3)
    ...
    return base_wp_curves, base_tf_curves, surf, surf_full

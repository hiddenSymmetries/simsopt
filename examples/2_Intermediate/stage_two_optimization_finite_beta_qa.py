...
CS_DISTANCE_WEIGHT = 100

# Threshold and weight for the curvature penalty in the objective function:
CURVATURE_THRESHOLD = 1.
CURVATURE_WEIGHT = Weight(1e-1)
...
total_current = Vmec(filename).external_current() / (2 * s.nfp)
...
Jcsdist = CurveSurfaceMinimumDistance(curves, s, CS_DISTANCE_THRESHOLD)

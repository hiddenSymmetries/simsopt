...
base_currents_finite_build = sum([[c]*numfilaments_n*numfilaments_b for c in base_currents], [])


coils = coils_via_symmetries(base_curves_finite_build, base_currents_finite_build, s.nfp, True)
bs = BiotSavart(coils)
...
Jdist = MinimumDistance(curves_for_dist, MIN_DIST)

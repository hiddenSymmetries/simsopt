...
from simsopt.field import BiotSavart, ExactField, DipoleField, coils_via_symmetries
from simsopt.geo import ExactMagnetGrid, SurfaceRZFourier, PermanentMagnetGrid, curves_to_vtk
...
coff = 0.07  # PM grid starts offset ~ 10 cm from the plasma surface
poff = 0.03  # PM grid end offset ~ 15 cm from the plasma surface
input_name = 'wout_HSX_lowres.nc'

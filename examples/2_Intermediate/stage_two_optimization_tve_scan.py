...
from simsopt.field import CoilCoilNetForces, CoilCoilNetTorques, TotalVacuumEnergy, CoilSelfNetForces
...
# wire cross section is a square 4 cm x 4 cm
a = 0.04
b = 0.04
...
OUT_DIR = "./stage_two_optimization_tve_scan/"

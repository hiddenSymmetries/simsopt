...
def test_abbv_force_calc_verification():
    """
    Test case to verify Abbv_Force_Calc function by comparing with full dipole_forces_from_A_F calculation.
    
    Test scenario:
    1. Start with 10 magnets, all moments zero, random positions
    2. Build full A_F tensor from positions
    3. Progressively activate magnets and test Abbv_Force_Calc vs dipole_forces_from_A_F
    """
    ...
    try:
        ...
        # Call Abbv_Force_Calc for first test - magnet 3 is NOT active yet
        forces_result_1, norm_result_1 = simsoptpp.Abbv_Force_Calc(moments, initial_forces, j_index_1, positions)
        ...
        j_index_2 = 2
        forces_result_2, norm_result_2 = simsoptpp.Abbv_Force_Calc(moments, forces_result_1, j_index_2, positions)
        moments[2] = 1.0
        ...
        j_index_3 = 6
        forces_result_3, norm_result_3 = simsoptpp.Abbv_Force_Calc(moments, forces_result_2, j_index_3, positions)
        moments[6] = 1.0
        ...
        j_index_4 = 3
        forces_result_4, norm_result_4 = simsoptpp.Abbv_Force_Calc(moments, forces_result_3, j_index_4, positions, sign=-1)
        ...
        j_index_5 = 25
        forces_result_5, norm_result_5 = simsoptpp.Abbv_Force_Calc(moments, forces_result_4, j_index_5, positions)
        moments[25] = 1.0
        ...
        j_index_6 = 17
        forces_result_6, norm_result_6 = simsoptpp.Abbv_Force_Calc(moments, forces_result_5, j_index_6, positions)
        moments[17] = 1.0
        ...
        j_index_7 = 13
        forces_result_7, norm_result_7 = simsoptpp.Abbv_Force_Calc(moments, forces_result_6, j_index_7, positions, sign=-1)
        ...
        j_index_8 = 27
        forces_result_8, norm_result_8 = simsoptpp.Abbv_Force_Calc(moments, forces_result_7, j_index_8, positions, sign=-1)
        ...
        j_index_9 = 21
        forces_result_9, norm_result_9 = simsoptpp.Abbv_Force_Calc(moments, forces_result_8, j_index_9, positions)
        moments[21] = 1.0
        ...
        j_index_10 = 20
        forces_result_10, norm_result_10 = simsoptpp.Abbv_Force_Calc(moments, forces_result_9, j_index_10, positions)
        moments[20] = 1.0
        ...
        if all_tests_passed:
            print("\nALL TESTS PASSED! Abbv_Force_Calc is working correctly.")
        else:
            print("\nSOME TESTS FAILED! There may be issues with Abbv_Force_Calc.")

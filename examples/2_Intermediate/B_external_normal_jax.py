...
import os
from simsopt.mhd import VirtualCasingJax

"""
This example illustrates the JAX virtual casing calculation, in which
...
vc = VirtualCasingJax.from_vmec(filename, src_nphi=48, trgt_ntheta=32, trgt_nphi=32)
print('automatically determined src_ntheta:', vc.src_ntheta)

# The VirtualCasingJax.from_vmec command writes a file
...
vc2 = VirtualCasingJax.load(vcasing_file)

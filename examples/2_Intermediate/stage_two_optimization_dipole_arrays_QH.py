...
from simsopt.field import BiotSavart, JaxCurrent, coils_via_symmetries
...
base_curves, all_curves = create_planar_curves_between_two_toroidal_surfaces(
    s, s_inner, s_outer, Nx, Ny, Nz, order=order, coil_coil_flag=True
)
...
def fun(dofs):
    ...
    # curr_val = CURRENTS_WEIGHT * DipoleJaxCurrentsObj.J()

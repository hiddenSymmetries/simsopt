...
from simsopt.field import BiotSavart, DipoleField, Current, \
    coils_via_symmetries, ExactField
from simsopt.geo import PermanentMagnetGrid, SurfaceRZFourier, \
    curves_to_vtk, create_equally_spaced_curves, ExactMagnetGrid
...
if in_github_actions:
    ...
    ntheta = nphi
    Nx = 70  # cartesian bricks but note that we are not modelling the cubic geometry!
    Ny = Nx
    Nz = Nx

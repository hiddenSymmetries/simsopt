...
from simsopt.geo import SurfaceRZFourier, create_equally_spaced_curves, \
    CurveLength, curves_to_vtk, CurveXYZFourier
from simsopt.field import Current, coils_via_symmetries, BiotSavart, coils_to_makegrid
...
coils_to_makegrid("coils.test", curves, currents, groups=None, nfp=1, stellsym=False)
curves_to_vtk(CurveXYZFourier.load_curves_from_file("coils.test",50,76),OUT_DIR + "curves_opt_after_loaded", close=True)
coils_to_makegrid("coils.results", CurveXYZFourier.load_curves_from_file("coils.test",5,76), currents, groups=None, nfp=1, stellsym=False)

...
kwargs['K'] = 20000  # Must be multiple of nhistory for now because I am lazy
kwargs['nhistory'] = 500
#kwargs['single_direction'] = 0
kwargs['dipole_grid_xyz'] = pm_opt.dipole_grid_xyz
kwargs['Nadjacent'] = 5000
...
iterations = np.linspace(0, 4 * kwargs['K'], len(R2_history), endpoint=False)

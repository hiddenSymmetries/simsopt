This example computes the passing Poincare map in the Landreman & Buller 2.5% beta QH configuration. 
...
An m = 1, n = 2 shear Alfven wave is included, with parameters descried in 
...
On macOS (06.29.25), the wallclock time is about 4 minutes using the command "mpiexec -n 8 python passing_map_perturbed.py".

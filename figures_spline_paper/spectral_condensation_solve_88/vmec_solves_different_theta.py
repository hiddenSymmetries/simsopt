...
if __name__ == "__main__":
    ...
    # inset axes zoomed 750x into the region where the spline and condensed
    ...
    # enough magnification to make that visible; 750x is).
    ...
    # Precise midpoint between the spline and condensed curves at their
    # point of maximum true (nearest-point, not same-index) geometric
    # divergence, refined at high sample density (ntheta=4000, scanning
    # every phi_array slice x both the exact and cond boundaries) --
    # centering on the midpoint (not on either curve) keeps both curves
    # symmetrically inside the zoom window even at this tight a crop.
    zoom_R, zoom_Z = 1.472111, -0.269308
    main_data_span = 1.318  # max of the plotted R and Z extents
    zoom_half_width = main_data_span / (2 * 750)  # 750x zoom

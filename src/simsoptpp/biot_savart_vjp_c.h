...
template<class T>
void biot_savart_gradgradB_vjp_kernel(AlignedPaddedVec& pointsx, AlignedPaddedVec& pointsy, AlignedPaddedVec& pointsz, T& gamma, T& dgamma_by_dphi, T& vgradgrad, T& res_gamma, T& res_dgamma_by_dphi);
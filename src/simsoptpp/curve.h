...
public:
    ...
    Array &gamma()
    {
        return check_the_cache("gamma", {numquadpoints, 3}, [this](Array &A)
                               { return gamma_impl(A, this->quadpoints); });
    }
    Array &gammadash()
    {
        return check_the_cache("gammadash", {numquadpoints, 3}, [this](Array &A)
                               { return gammadash_impl(A); });
    }
    Array &gammadashdash()
    {
        return check_the_cache("gammadashdash", {numquadpoints, 3}, [this](Array &A)
                               { return gammadashdash_impl(A); });
    }
    Array &gammadashdashdash()
    {
        return check_the_cache("gammadashdashdash", {numquadpoints, 3}, [this](Array &A)
                               { return gammadashdashdash_impl(A); });
    }

    virtual Array &dgamma_by_dcoeff()
    {
        return check_the_cache("dgamma_by_dcoeff", {numquadpoints, 3, num_dofs()}, [this](Array &A)
                               { return dgamma_by_dcoeff_impl(A); });
    }
    virtual Array &dgammadash_by_dcoeff()
    {
        return check_the_cache("dgammadash_by_dcoeff", {numquadpoints, 3, num_dofs()}, [this](Array &A)
                               { return dgammadash_by_dcoeff_impl(A); });
    }
    virtual Array &dgammadashdash_by_dcoeff()
    {
        return check_the_cache("dgammadashdash_by_dcoeff", {numquadpoints, 3, num_dofs()}, [this](Array &A)
                               { return dgammadashdash_by_dcoeff_impl(A); });
    }
    virtual Array &dgammadashdashdash_by_dcoeff()
    {
        return check_the_cache("dgammadashdashdash_by_dcoeff", {numquadpoints, 3, num_dofs()}, [this](Array &A)
    ...
    Array &kappa()
    {
        return check_the_cache("kappa", {numquadpoints}, [this](Array &A)
                               { return kappa_impl(A); });
    }

    Array &dkappa_by_dcoeff()
    {
        return check_the_cache("dkappa_by_dcoeff", {numquadpoints, num_dofs()}, [this](Array &A)
                               { return dkappa_by_dcoeff_impl(A); });
    }

    Array &torsion()
    {
        return check_the_cache("torsion", {numquadpoints}, [this](Array &A)
                               { return torsion_impl(A); });
    }

    Array &dtorsion_by_dcoeff()
    {
        return check_the_cache("dtorsion_by_dcoeff", {numquadpoints, num_dofs()}, [this](Array &A)
                               { return dtorsion_by_dcoeff_impl(A); });
    }

    Array &incremental_arclength()
    {
        return check_the_cache("incremental_arclength", {numquadpoints}, [this](Array &A)
                               { return incremental_arclength_impl(A); });
    }

    Array &dincremental_arclength_by_dcoeff()
    {
        return check_the_cache("dincremental_arclength_by_dcoeff", {numquadpoints, num_dofs()}, [this](Array &A)
                               { return dincremental_arclength_by_dcoeff_impl(A); });
    }

...
PYBIND11_MODULE(simsoptpp, m) {
    ...
    m.def("BMP_MSE", &BMP_MSE, py::arg("A_obj"), py::arg("b_obj"), py::arg("K") = 1000, py::arg("verbose") = false, py::arg("grid_aligned") = true, py::arg("nhistory") = 21, py::arg("backtracking") = 0, py::arg("continuous") = false, py::arg("alpha") = 1, py::arg("dipole_grid_xyz"));

...
PYBIND11_MODULE(simsoptpp, m) {
    ...
    m.def("BMP_MSE", &BMP_MSE, py::arg("A_obj"), py::arg("b_obj"), py::arg("K") = 1000, py::arg("verbose") = false, py::arg("grid_aligned") = true, py::arg("nhistory") = 21, py::arg("backtracking") = 0, py::arg("continuous") = false, py::arg("dipole_grid_xyz"), py::arg("single_direction") = -1, py::arg("last_dipole") = false, py::arg("Nadjacent") = 6, py::arg("multi_magnets_per_iteration") = false);
    m.def("BMP_MC", &BMP_MC, py::arg("A_obj"), py::arg("b_obj"), py::arg("ATb"), py::arg("K") = 1000, py::arg("verbose") = false, py::arg("grid_aligned") = true, py::arg("nhistory") = 21);

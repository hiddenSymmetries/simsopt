...
template<template<class, std::size_t, xt::layout_type> class T>
std::vector<double> find_bounce_points(shared_ptr<BoozerMagneticField<T>> field, double s, double theta0, double zeta0, double lam, int nfp, int option, int nmax, int nzeta=1000, int digits=16, double derivative_tol=1e-3, double argmin_tol=1e-3, double root_tol=1e-8);

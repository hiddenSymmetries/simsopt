                    ...
                    for(int m = 0; m < ndofs; m+=simd_size){
                        ...
                        for(int n = m; n < ndofs; n++){
                            ...
                            for(int l = 0; l < 3; l++){
                                ...
                                d2Bij0_mn = d2B_dx2(i, j, 0, l, 0) * dx_ds_ij0m * dx_ds_ijln+ d2Bij0_mn;
                                d2Bij1_mn = d2B_dx2(i, j, 0, l, 1) * dx_ds_ij0m * dx_ds_ijln+ d2Bij1_mn;
                                d2Bij2_mn = d2B_dx2(i, j, 0, l, 2) * dx_ds_ij0m * dx_ds_ijln+ d2Bij2_mn;
                                d2Bij0_mn = d2B_dx2(i, j, 1, l, 0) * dx_ds_ij1m * dx_ds_ijln+ d2Bij0_mn;
                                d2Bij1_mn = d2B_dx2(i, j, 1, l, 1) * dx_ds_ij1m * dx_ds_ijln+ d2Bij1_mn;
                                d2Bij2_mn = d2B_dx2(i, j, 1, l, 2) * dx_ds_ij1m * dx_ds_ijln+ d2Bij2_mn;
                                d2Bij0_mn = d2B_dx2(i, j, 2, l, 0) * dx_ds_ij2m * dx_ds_ijln+ d2Bij0_mn;
                                d2Bij1_mn = d2B_dx2(i, j, 2, l, 1) * dx_ds_ij2m * dx_ds_ijln+ d2Bij1_mn;
                                d2Bij2_mn = d2B_dx2(i, j, 2, l, 2) * dx_ds_ij2m * dx_ds_ijln+ d2Bij2_mn;
                            }

...
typedef SurfaceNewQuadPoints<PyArray> PySurfaceNewQuadPoints;
...
void init_surfaces(py::module_ &m){
    ...
    auto pysurfacenewquadpoints = py::class_<PySurfaceNewQuadPoints, shared_ptr<PySurfaceNewQuadPoints>, PySurfaceNewQuadPointsTrampoline<PySurfaceNewQuadPoints>, PySurface>(m, "SurfaceNewQuadPoints")

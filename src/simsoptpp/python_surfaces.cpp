...
template <typename T, typename S> void register_common_surface_methods(S &s) {
    s.def("gamma", &T::gamma)
     ...
     .def("dgammadash1dash1_by_dcoeff", &T::dgammadash1dash1_by_dcoeff)
     .def("dgammadash1dash2_by_dcoeff", &T::dgammadash1dash2_by_dcoeff)
     .def("dgammadash2dash2_by_dcoeff", &T::dgammadash2dash2_by_dcoeff)
     .def("surface_curvatures", &T::surface_curvatures)
     .def("dsurface_curvatures_by_dcoeff", &T::dsurface_curvatures_by_dcoeff)

...
template <class SurfaceBase = PySurface> class PySurfaceTrampoline : public SurfaceBase {
    public:
        ...
        virtual void gammadash1dash1dash1_lin(PyArray& data, PyArray& quadpoints_phi, PyArray& quadpoints_theta) override {
            PYBIND11_OVERLOAD_PURE(void, SurfaceBase, gammadash1dash1dash1_lin, data, quadpoints_phi, quadpoints_theta);
        }
        virtual void gammadash1dash1dash2_lin(PyArray& data, PyArray& quadpoints_phi, PyArray& quadpoints_theta) override {
            PYBIND11_OVERLOAD_PURE(void, SurfaceBase, gammadash1dash1dash2_lin, data, quadpoints_phi, quadpoints_theta);
        }
        virtual void gammadash1dash2dash2_lin(PyArray& data, PyArray& quadpoints_phi, PyArray& quadpoints_theta) override {
            PYBIND11_OVERLOAD_PURE(void, SurfaceBase, gammadash1dash2dash2_lin, data, quadpoints_phi, quadpoints_theta);
        }
        virtual void gammadash2dash2dash2_lin(PyArray& data, PyArray& quadpoints_phi, PyArray& quadpoints_theta) override {
            PYBIND11_OVERLOAD_PURE(void, SurfaceBase, gammadash2dash2dash2_lin, data, quadpoints_phi, quadpoints_theta);
        }

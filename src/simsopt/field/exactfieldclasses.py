...
__all__ = ['ToroidalField', 'PoloidalField', 'ScalarPotentialRZMagneticField',
           'CircularCoil', 'Dommaschk', 'Reiman', 'InterpolatedField', 'ExactField',
           'MirrorModel']
...
class ExactField(MagneticField): #make dims and phiThetas class object?
    ...
    def __init__(self, dipole_grid, dipole_vectors, dims, phiThetas, stellsym=True, nfp=1, coordinate_flag='cartesian', m_maxima=None, R0=1):
        super().__init__()        

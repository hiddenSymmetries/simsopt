...
from .._core.descriptor import Integer, Float
...
class MGrid():
    ...
    '''
    nr: int = Integer(min_value=1, default=51)
    nz: int = Integer(min_value=1, default=51)
    nphi: int = Integer(min_value=1, default=24)
    nfp: int = Integer(min_value=1, default=2)
    rmin: float = Float(default=0.2)
    rmax: float = Float(default=0.4)
    zmin: float = Float(default=-0.1)
    zmax: float = Float(default=0.1)

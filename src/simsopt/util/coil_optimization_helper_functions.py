...
def make_filament_from_voxels(current_voxels_grid, final_threshold, truncate=False, num_fourier=16):
    ...
    Parameters
    ----------
    current_voxels_grid (CurrentVoxelsGrid): CurrentVoxelsGrid class object.
    final_threshold (float): The largest threshold used to optimize the current voxel solution.
    truncate (bool, default False): Whether to truncate the curve at small coefficients.
    num_fourier (int, default 16): Number of Fourier modes to use.

    Returns
    -------
    curve (CurveXYZFourier): CurveXYZFourier class object.
    """
    from simsopt.geo import CurveXYZFourier

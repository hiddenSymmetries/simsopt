"""
This file contains a helper function that returns a simsopt.field.Coil object that represents a current along the z-axis. 
...
def current_along_z(current, quadpoints=100, x0=0., y0=0., zscale=10, coil_dofs_fixed=True):
    ...
    """
    return Coil(Current(current), CurveAlongZ(quadpoints, x0, y0, zscale, coil_dofs_fixed=coil_dofs_fixed))

...
def initialize_coils(config_flag, TEST_DIR, OUT_DIR, s):
    ...
    Args:
        ...
        OUT_DIR: String denoting where to save output files.
        s: plasma boundary surface.
    Returns:
...
def make_optimization_plots(RS_history, m_history, m_proxy_history, pm_opt, OUT_DIR):
    ...
    Args:
        ...
        OUT_DIR: String denoting where to write output files.
    """
...
def write_pm_optimizer_to_famus(OUT_DIR, pm_opt):
    ...
    Args:
        OUT_DIR: string denoting the output directory for saved files.

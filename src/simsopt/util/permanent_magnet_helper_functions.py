...
def coil_optimization(s, bs, base_curves, curves, out_dir=Path('')):
    """
...
def initialize_coils(config_flag, TEST_DIR, s, out_dir=Path('')):
    """
...
def make_optimization_plots(RS_history, m_history, m_proxy_history, pm_opt, out_dir=Path('')):
    """
...
def make_Bnormal_plots(bs, s_plot, out_dir=Path(''), bs_filename="Bnormal"):
    """
...
def write_pm_optimizer_to_famus(pm_opt, out_dir=Path('')):
    """
    ...
    Args:
        out_dir: Path object for the output directory for saved files.
        pm_opt: A PermanentMagnetGrid object.
    """

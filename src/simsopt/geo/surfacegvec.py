...
__all__ = ["SurfaceGVECFourier"]


class SurfaceGVECFourier(Optimizable):
    """
    ...
    def change_resolution(self, mpol, ntor, stellsym=None):
        ...
        Returns:
            A new :obj:`SurfaceGVECFourier` instance with the desired resolution.
        """
        if stellsym is None:
            stellsym = self.stellsym
        surf = SurfaceGVECFourier(mpol, ntor, nfp=self.nfp, stellsym=stellsym)

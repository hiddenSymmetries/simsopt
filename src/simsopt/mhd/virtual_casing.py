    ...
    * src_nphi), (src_nphi - 0.5) / (src_nphi * nfp), src_nphi)``
    ...
    def from_vmec(cls, vmec, src_nphi, src_ntheta=None, trgt_nphi=None, trgt_ntheta=None, use_stellsym=True, digits=6, filename="auto"):
        ...
        if stellsym:
            ...
            ran = "field period"
        surf = SurfaceRZFourier.with_grid_range(mpol=vmec.wout.mpol, ntor=vmec.wout.ntor, nfp=nfp,
        ...
        trgt_surf = SurfaceRZFourier.with_grid_range(mpol=vmec.wout.mpol, ntor=vmec.wout.ntor, nfp=nfp,
